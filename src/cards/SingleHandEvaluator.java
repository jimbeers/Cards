...
public class SingleHandEvaluator {
	Card cardA1;
	Card cardA2;
	Card cardB1;
	Card cardB2;
	...
	public SingleHandEvaluator(Card a1, Card a2, int interations) {
		cardA1 = a1;
		cardA2 = a2;
	...
	public static void main(String[] args) {
		SingleHandEvaluator v = new SingleHandEvaluator(new Card(12,1), new Card(12,2), 1000); //Q clubs, K clubs
